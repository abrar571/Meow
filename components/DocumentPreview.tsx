...
const DocumentPreview: React.FC<DocumentPreviewProps> = ({ doc, onBack, onPurchase, userPoints }) => {
  ...
  const canAfford = userPoints >= doc.priceCoins;
          ...
          <div className="bg-[#0f0f11] p-6 rounded-2xl shadow-sm border border-white/10">
            ...
            {!canAfford && (
              <p className="text-xs text-red-400 text-center mt-3">
                You need {doc.priceCoins - userPoints} more coins.
              </p>
            )}
          </div>
